...
class WC_Xendit_DD_Kbank_Mb extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 700000;
    const DEFAULT_MINIMUM_AMOUNT = 20;

    const XENDIT_METHOD_CODE = 'DD_KBANK_MB';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_kbank_mb';
        ...
        $this->default_title = 'Kasikorn Bank (KBank)';
        ...
        $this->method_title = __('Xendit Kasikorn Bank (KBank)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-kbank-mb-settings.php');
    }
