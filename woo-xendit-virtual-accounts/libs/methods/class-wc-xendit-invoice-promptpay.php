...
class WC_Xendit_Promptpay extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 700000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'PROMPTPAY';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_promptpay';
        ...
        $this->method_title = __('Xendit PromptPay', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-promptpay-settings.php');
    }
