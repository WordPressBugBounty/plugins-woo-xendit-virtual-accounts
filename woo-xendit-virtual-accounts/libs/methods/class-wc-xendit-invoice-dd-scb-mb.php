...
class WC_Xendit_DD_Scb_Mb extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 700000;
    const DEFAULT_MINIMUM_AMOUNT = 20;

    const XENDIT_METHOD_CODE = 'DD_SCB_MB';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_scb_mb';
        ...
        $this->default_title = 'Siam Commercial Bank (SCB)';
        ...
        $this->method_title = __('Xendit Siam Commercial Bank (SCB)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-scb-mb-settings.php');
    }
