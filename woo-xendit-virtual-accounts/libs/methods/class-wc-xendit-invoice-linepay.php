...
class WC_Xendit_Linepay extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 50000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'LINEPAY';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_linepay';
        ...
        $this->method_title = __('Xendit LINE Pay', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-linepay-settings.php');
    }
