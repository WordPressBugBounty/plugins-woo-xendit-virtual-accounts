...
class WC_Xendit_DD_Bay_Mb extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 700000;
    const DEFAULT_MINIMUM_AMOUNT = 20;

    const XENDIT_METHOD_CODE = 'DD_BAY_MB';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_bay_mb';
        ...
        $this->default_title = 'Bank of Ayudhya (BAY)';
        ...
        $this->method_title = __('Xendit Bank of Ayudhya (BAY)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-bay-mb-settings.php');
    }
