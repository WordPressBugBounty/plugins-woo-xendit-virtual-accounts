...
return apply_filters(
    ...
    array(
        'channel_name' => array(
            ...
            'placeholder' => 'Siam Commercial Bank Mobile Banking',
        ),
        'payment_description' => array(
            ...
            'placeholder' => 'Pay at your nearest Siam Commercial Bank Mobile Banking via Xendit',
        )
    )
);
