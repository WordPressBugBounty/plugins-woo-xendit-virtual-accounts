...
if (defined('LOCAL_MODE') && LOCAL_MODE === true) {
    $xendit_gateway_settings['notification_options'] = array(
        'title' => esc_html__('Notification Options', 'woo-xendit-virtual-accounts'),
        'type' => 'title',
    );

    $xendit_gateway_settings['notification_url'] = array(
...
return apply_filters('wc_xendit_gateway_settings', $xendit_gateway_settings);
